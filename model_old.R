...
start_time <- Sys.time()
rf <- randomForest(WON__C ~ FIELDS_COMPLETED + Code_industry + ACCOUNT_TIER__C + ACCOUNT_TYPE__C + CUSTOMER_CLASSIFICATION__C + CREDIT_LIMIT_ESTABLISHED__C + CORE_RECORD_TYPE__C + QUALIFICATION_APPROVAL_STATUS__C + OPENTIME + LASTACTTIME
